...
void CDelphiEnergy::energy_nonl(real& fEnergy_Nonlinear, int& iGridOutput)
{
	int i, j, k, iw, n;
    real fEnergy_Solvation, fEnergy_Osmetic;
	real gX, gY, gZ;
	real fCarica, fCutedges_i, fCutedges_j, fCutedges_k, goff;
	real dhi1, dhi2, dhi3, dhi4, dhi5, fCarica_Temp, fPhi, c;
	SGridValue<real> fGridValue_Temp;

	fEnergy_Solvation=0.0; fEnergy_Osmetic=0.0;  n=0;
