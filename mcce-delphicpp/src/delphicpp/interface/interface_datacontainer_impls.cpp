...
template const SExtrema<integer>& IDataContainer::getKey_constRef(const string&);
template const SExtrema<real>& IDataContainer::getKey_constRef(const string&);
...
template const vector<real>& IDataContainer::getKey_constRef(const string&);
...
template const vector< SExtrema<real> >& IDataContainer::getKey_constRef(const string&);
template const vector< SGrid<integer> >& IDataContainer::getKey_constRef(const string&);
template const vector< SGrid<real> >& IDataContainer::getKey_constRef(const string&);
template const vector< SGridValue<real> >& IDataContainer::getKey_constRef(const string&);
template const vector< SGridValue<integer> >& IDataContainer::getKey_constRef(const string&);
...
template const SExtrema<integer> * IDataContainer::getKey_constPtr(const string&);
template const SExtrema<real> * IDataContainer::getKey_constPtr(const string&);
...
template const vector<real>* IDataContainer::getKey_constPtr(const string&);
...
template const vector< SExtrema<real> >* IDataContainer::getKey_constPtr(const string&);
template const vector< SGrid<integer> >* IDataContainer::getKey_constPtr(const string&);
template const vector< SGrid<real> >* IDataContainer::getKey_constPtr(const string&);
template const vector< SGridValue<real> >* IDataContainer::getKey_constPtr(const string&);
template const vector< SGridValue<integer> >* IDataContainer::getKey_constPtr(const string&);
...
template const SGrid<integer> ** IDataContainer::getKey_constPtr(const string&,const int&,const int&);

//----------template <class T> const T*** getKey_constPtr(const string& strKey,const int& iRows,const int& iColumns,const int& iPages)
template const SGrid<integer> *** IDataContainer::getKey_constPtr(const string&,const int&,const int&,const int&);
...
template const SGrid<integer> **** IDataContainer::getKey_constPtr(const string&,const int&,const int&,const int&,const int&);
template const real *** IDataContainer::getKey_constPtr(const string&,const int&,const int&,const int&);
...
template SExtrema<integer>& IDataContainer::getKey_Ref(const string&);
template SExtrema<real>& IDataContainer::getKey_Ref(const string&);
template CForce& IDataContainer::getKey_Ref(const string&);
template CAtomPdb& IDataContainer::getKey_Ref(const string&);
template vector<real>& IDataContainer::getKey_Ref(const string&);
template vector<int>& IDataContainer::getKey_Ref(const string&);
template vector<bool>& IDataContainer::getKey_Ref(const string&);
template vector< SExtrema<real> >& IDataContainer::getKey_Ref(const string&);
template vector< SGrid<integer> >& IDataContainer::getKey_Ref(const string&);
template vector< SGrid<real> >& IDataContainer::getKey_Ref(const string&);
template vector< SGridValue<real> >& IDataContainer::getKey_Ref(const string&);
template vector< SGridValue<integer> >& IDataContainer::getKey_Ref(const string&);
...
template SExtrema<integer> IDataContainer::getKey_Val(const string&);
template SExtrema<real> IDataContainer::getKey_Val(const string&);
template CForce IDataContainer::getKey_Val(const string&);
template CAtomPdb IDataContainer::getKey_Val(const string&);
template vector<real> IDataContainer::getKey_Val(const string&);
template vector<int> IDataContainer::getKey_Val(const string&);
template vector<bool> IDataContainer::getKey_Val(const string&);
template vector< SExtrema<real> > IDataContainer::getKey_Val(const string&);
template vector< SGrid<integer> > IDataContainer::getKey_Val(const string&);
template vector< SGrid<real> > IDataContainer::getKey_Val(const string&);
template vector< SGridValue<real> > IDataContainer::getKey_Val(const string&);
template vector< SGridValue<integer> > IDataContainer::getKey_Val(const string&);
...
template SExtrema<integer> * IDataContainer::getKey_Ptr(const string&);
template SExtrema<real> * IDataContainer::getKey_Ptr(const string&);
template CForce * IDataContainer::getKey_Ptr(const string&);
template CAtomPdb * IDataContainer::getKey_Ptr(const string&);
template vector<real>* IDataContainer::getKey_Ptr(const string&);
template vector<int>* IDataContainer::getKey_Ptr(const string&);
template vector<bool>* IDataContainer::getKey_Ptr(const string&);
template vector< SExtrema<real> >* IDataContainer::getKey_Ptr(const string&);
template vector< SGrid<integer> >* IDataContainer::getKey_Ptr(const string&);
template vector< SGrid<real> >* IDataContainer::getKey_Ptr(const string&);
template vector< SGridValue<real> >* IDataContainer::getKey_Ptr(const string&);
template vector< SGridValue<integer> >* IDataContainer::getKey_Ptr(const string&);
...
template real *** IDataContainer::getKey_Ptr(const string&,const int&,const int&,const int&);
template SGrid <integer> *** IDataContainer::getKey_Ptr(const string&,const int&,const int&,const int&);
