...
//    cout << "amaxf,RMaxTemp: "<< amax << " " << fRMaxTemp << endl;
    ...
    //SGrid<int> test = optCast<real>(amin);
//    cout << " LimEps.nMax,amax: "<< LimEps.nMax << " " << amax;
//    cout << "amax,amin: " << amax << amin << endl;


//    cout << "optCast <integer,real> (amin)-2: " << iamin << endl;

    //determine the limit of limEps, no larger than igrdd and no less than 1.
    LimEps.nMin=optMax(optCast <integer,real> (amin)-2,1);
    LimEps.nMax=optMin(optCast <integer,real> (amax)+2,iGrid);
//    cout << "LimEps" << LimEps << endl;
    ...
    if(iGaussian==0)
    {
        if(space_debug) cout << "go to setout..." << endl;
        setout();
    }
    else
    {
        if(space_debug) cout << "go to setgaussian..." << endl;
        //setgaussian();
    }
    ...
    if(iGaussian==0)
    {
        if(space_debug) cout <<"going to VdwToMs..." << endl;
