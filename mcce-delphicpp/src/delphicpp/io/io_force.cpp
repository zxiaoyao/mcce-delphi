...
//-----------------------------------------------------------------------//
integer CIO::FindRecordIndex(const string& strAtom, const string& strResidue, const string& strResidueNum, const string& strChain, const integer& iRecordNum, vector<CForce>* prgaf)
{
   integer iThisRecord;
...
//-----------------------------------------------------------------------//
integer CIO::FindRecord(const string& strAtom, const string& strResidue, const string& strResidueNum, const string& strChain, const int& iFileType, real& fValue)
{
   integer iRecordNum = 0;
...
//   real   fCharge, fChargeSum, fError;
//
//   fChargeSum = 0.0;
//   
//   if (bSurfCrgInSite)
...
void CIO::printForce(const int & iFileType)
{
   ...
   for (integer i = 0; i < iRecordNum; i++)
   {
