...
real CDelphiFastSOR::calculateRelaxFactor()
{
   real fRelaxFactor = 0.0;
   ...
   vector<real> sn2(sn1),sn3(sn1);

   real recipr = 1.0/sqrt((real)iGrid);
   ...
   itrOddPoints(0); // forWhom = 0

   itrEvenPoints(0); // forWhom = 0
