   ...
   try
   {
      ...
      switch (typearg)
      {
         ...
         case 23:
         {
             ...
             */
            //fGridConverge = boost::lexical_cast<delphi::real>(strArgument);
         ...
         case 24:
            fSpectralRadius = boost::lexical_cast<delphi::real>(strArgument);
         ...
         case 29:
         {
             ...
             */
            //fRadPolExt = boost::lexical_cast<delphi::real>(strArgument);

            CObsoleteStatement warning(strLineNoSpace);
            break;
         }
         case 30:
            fRelaxParam = boost::lexical_cast<delphi::real>(strArgument);
            if (0.0 > fRelaxParam || 2.0 < fRelaxParam) COutOfRange_RELPAR warning(fRelaxParam);
            bManualRelaxParam = true;
            break;
         case 31:
            vctfSalt[1] = boost::lexical_cast<delphi::real>(strArgument);
            if (0.0 > vctfSalt[1] || 10.0 < vctfSalt[1]) COutOfRange_SALT2 warning(vctfSalt[1]);
            break;
         case 32:
            vctfProbeRadius[1] = boost::lexical_cast<delphi::real>(strArgument);
         ...
         case 36:
            ...
            break;
         case 37:
            fRmsc = boost::lexical_cast<delphi::real>(strArgument);
            if (0.0 >= fRmsc || 1.0 <= fRmsc) COutOfRange_RMSC warning(fRmsc);
            break;
         case 38:
            fMaxc = boost::lexical_cast<delphi::real>(strArgument);
         ...
         case 39:
         {
             ...
             */
            //fNormc = boost::lexical_cast<delphi::real>(strArgument) ;

            CObsoleteStatement warning(strLineNoSpace);
            break;
         }
         case 40:
            gfPotentialDrop.nX = boost::lexical_cast<delphi::real>(strArgument);
            ...
            break;
         case 41:
            gfPotentialDrop.nY = boost::lexical_cast<delphi::real>(strArgument);
            ...
            break;
         case 42:
            gfPotentialDrop.nZ = boost::lexical_cast<delphi::real>(strArgument);
            ...
            break;
         case 43:
            fPotentialUpperBond = boost::lexical_cast<delphi::real>(strArgument);
            if (0.0 >= fPotentialUpperBond || 10.0 <= fPotentialUpperBond) COutOfRange_ATPODS warning(fPotentialUpperBond);
            break;
         case 44:
            fTemper = boost::lexical_cast<delphi::real>(strArgument);
