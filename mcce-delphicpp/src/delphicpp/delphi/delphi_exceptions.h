...
{
   public:
   COutOfRange_PERFIL(real& fPercentageFill)
      {
...
{
   public:
   COutOfRange_EXDI(real& fExDielec)
      {
...
{
   public:
   COutOfRange_GRDCON(real& fGridConverge)
      {
...
{
   public:
   COutOfRange_GSIZE(integer& iGrid)
      {
...
{
   public:
   COutOfRange_INDI(real& fInDielec)
      {
...
{
   public:
   COutOfRange_IONRAD(real& fIonRadius)
      {
...
{
   public:
   COutOfRange_PRBRAD(real& fPrbrad)
      {
...
{
   public:
   COutOfRange_PRBRAD2(real& fPrbrad)
      {
...
{
   public:
   COutOfRange_RELFAC(real& fSpectralRadius)
      {
...
{
   public:
   COutOfRange_RELPAR(real& fRelaxParam)
      {
...
{
   public:
   COutOfRange_ATPODS(real& fPotentialUpperBond)
      {
...
{
   public:
   COutOfRange_TEMPER(real& fTemper)
      {
